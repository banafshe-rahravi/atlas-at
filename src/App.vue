<template>
  <div class="container">
    <ul class="content">
      <li class="content-1">
        <h2 class="content-title">Atlas: The Ultimate Guide to the World</h2>
        <p class="content-desc">Atlas is a website that lists every country with their flags and facts. You can explore
          the
          world map, search by<br>
